...
- `IPTV-Windows-Executor-0.3.14.zip`: Windows package with the unified IPTV Automation launcher and safe updater.
- `IPTV-Chrome-Extension-0.4.14.zip`: Chrome extension package.
