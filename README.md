...
- `IPTV-Windows-Executor-0.3.20.zip`: Windows package with the unified IPTV Automation launcher and safe updater.
- `IPTV-Chrome-Extension-0.4.19.zip`: Chrome extension package.
