...
- `IPTV-Windows-Executor-0.3.15.zip`: Windows package with the unified IPTV Automation launcher and safe updater.
- `IPTV-Chrome-Extension-0.4.15.zip`: Chrome extension package.
